...
![20210819225530](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819225530.png)
...
![20210819230315](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819230315.png)
...
![20210819230630](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819230630.png)
...
![20210819230853](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819230853.png)
...
![20210819230937](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819230937.png)
...
![20210819231006](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231006.png)

说明: 经过一系列的方法调用，最后达到的状态是禁用t2线程，因为调用了LockSupport.lock。

* t1线程调用lock.unlock，其方法调用顺序如下，只给出了主要的方法调用。

![20210819231057](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231057.png)
...
![20210819231115](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231115.png)
...
![20210819231243](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231243.png)
...
![20210819231433](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231433.png)
...
![20210819231506](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231506.png)

说明: p2线程调用lock.lock后，会禁止p2线程的继续运行，因为执行了LockSupport.park操作。

* c1线程调用lock.lock，由前面的分析得到如下的最终状态。

![20210819231523](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231523.png)
...
![20210819231545](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231545.png)
...
![20210819231645](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231645.png)
...
![20210819231739](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231739.png)
...
![20210819231803](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231803.png)
...
![20210819231923](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231923.png)

说明: 其中，head设置为包含c1线程的结点，c1继续运行。

* c1线程执行fullCondtion.signal，其方法调用顺序如下，只给出了主要的方法调用。

![20210819231949](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819231949.png)
...
![20210819232012](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819232012.png)

说明: 最终c2线程会获取锁资源，继续运行用户逻辑。

* c2线程执行emptyCondition.await，由前面的第七步分析，可知最终的状态如下。

![20210819232034](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819232034.png)
...
![20210819232059](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819232059.png)

* p2继续运行，执行emptyCondition.signal，根据第九步分析可知，最终到达的状态如下。

![20210819232111](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819232111.png)
...
![20210819232135](https://marlowe.oss-cn-beijing.aliyuncs.com/img/20210819232135.png)
...
[JUC锁: 锁核心类AQS详解](https://www.pdai.tech/md/java/thread/java-thread-x-lock-AbstractQueuedSynchronizer.html#abstractqueuedsynchronizer%E7%A4%BA%E4%BE%8B%E8%AF%A6%E8%A7%A3%E4%B8%80)